...
public class LinkedHashMapTest {
     ...
     * 如果accessOrder为false，就是HasMap的get{@link java.util.HashMap#get(Object)}
     ...
     * 就是用HashMap的put方法{@link java.util.HashMap#put(Object, Object)}之后
     * 如果是插入链表，则由HashMap调用子类函数{@link java.util.LinkedHashMap#afterNodeAccess(HashMap.Node)}
     * 建立与插入节点的关系
